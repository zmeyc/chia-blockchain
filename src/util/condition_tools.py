...
def aggsig_in_conditions_dict(conditions_dict: Dict[ConditionOpcode, List[ConditionVarList]]) -> List[ConditionVarList]:
    agg_sig_conditions = []
...
def conditions_dict_for_solution(
    solution,
) -> Tuple[Optional[Err], Optional[Dict[ConditionOpcode, List[ConditionVarList]]], uint64]:
