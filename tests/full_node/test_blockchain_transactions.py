...
class TestBlockchainTransactions:
    ...
    async def test_assert_my_coin_id(self, two_nodes):
        ...
        valid_dic = {valid_cvl.opcode: [valid_cvl]}
        ...
        bad_dic = {bad_cvl.opcode: [bad_cvl]}
    ...
    async def test_assert_coin_consumed(self, two_nodes):
        ...
        block1_dic = {block1_cvl.opcode: [block1_cvl]}
        ...
        block2_dic = {block2_cvl.opcode: [block2_cvl]}
    ...
    async def test_assert_fee_condition(self, two_nodes):
        ...
        cvl_fee = ConditionVarList(ConditionOpcode.ASSERT_FEE, int_to_bytes(10), None)
        block1_dic = {cvl_fee.opcode: [cvl_fee]}
        ...
        # This condition requires fee to be 10 mojo
        cvl_fee = ConditionVarList(ConditionOpcode.ASSERT_FEE, int_to_bytes(10), None)
        condition_dict = {cvl_fee.opcode: [cvl_fee]}
        valid_spend_bundle = wallet_a.generate_signed_transaction(
