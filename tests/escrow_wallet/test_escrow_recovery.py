...
class TestWalletSimulator:
    ...
    async def test_wallet_recovery(self, three_wallet_nodes):
        ...
        # save lost wallet's backup string
        backup_string = escrow_wallet_0.get_backup_string()

        # generate escrow wallet to perform recovery
        ...
        # add funds to recovery wallet to cover the stake
        ...
        # send transaction to restore lost wallets coins to escrow
        ...
        # send transaction to move escrow coins to this wallet
        await escrow_wallet_1.recover_escrow_coins()
        ...
        assert await escrow_wallet_1.get_confirmed_balance() == funds + lost_funds
